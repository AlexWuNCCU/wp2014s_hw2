...
$(document).ready(function() {
	...
	$('#joinform').submit(function(e) {
	    ...
	    //custom goal + GA
		_vis_opt_goal_conversion(56,208);
        _gaq.push(['_trackEvent', 'Submits', 'FormSubmitted2']);
...
function setUnreadText() {
	//nothing read
	if (readLeftOff == 0) {
		$("#readStatus").html('Looks like you have <a href="#1">' + ideaList.length + ' unread</a> sections.');
	}
	//some read
		...
		$("#readStatus").html('Looks like you have <a href="#' + nextToRead + '">' + ideasOutstanding + ' unread</a> sections.');
	}
	...
	//everything read but not signed up
		...
		$("#readStatus").html('You\'ve read all. <a href="Form.htm">Comment</a> for more conversations.');	
